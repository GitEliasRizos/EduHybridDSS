...
class GroupDecisionTab(QWidget):
    ...
    def __init__(self, user_manager: UserDatabaseManager = None, current_user: str = "admin"):
        super().__init__()
        self.user_manager = user_manager or UserDatabaseManager()
...
class AHPGroupAnalysisTab(QWidget):
    ...
    def __init__(self, user_manager: UserDatabaseManager):
        super().__init__()
